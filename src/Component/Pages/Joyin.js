...
const initialFriendsData = [
  { name: "Joyin", pic: pic1, reviews: 8, following: 4, email: "Joyin@gmail.com", Bio: "Hello I'm Joyin", description: "Joyin: An intrepid explorer of cultural landscapes, blending artistry and anthropology to uncover the beauty in diversity ", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
  { name: "Tina", pic: pic3, reviews: 2, following: 5, email: "Tina@gmail.com", Bio: "Hello I'm Tina", description: "Tina: A tech-savvy trailblazer, harnessing innovation to create seamless experiences and shape the future of digital connectivity. ", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
  { name: "Heidi", pic: pic2, reviews: 1, following: 7, email: "Heidi@gmail.com", Bio: "Hello I'm Heidi", description: "Heidi: A compassionate healer, blending ancient wisdom with modern practices to nurture holistic wellness in mind, body, and spirit.", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
  { name: "Jess", pic: pic4, reviews: 9, following: 8, email: "Jess@gmail.com", Bio: "Hello I'm Jess", description: "Jess: A visionary eco-entrepreneur, weaving sustainability into every aspect of life with boundless creativity and infectious enthusiasm.", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
  { name: "Tenders", pic: pic5, reviews: 3, following: 1, email: "Tenders@gmail.com", Bio: "Hello I'm Tenders", description: "Tenders: A culinary virtuoso, crafting unforgettable gastronomic experiences that tantalize the senses and ignite the soul.", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
  { name: "Albert", pic: pic6, reviews: 2, following: 8, email: "Albert@gmail.com", Bio: "Hello I'm Albert", description: "Albert: A cerebral architect of code, sculpting digital realms with precision and ingenuity to push the boundaries of possibility.", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
  { name: "Alberta", pic: pic7, reviews: 2, following: 4, email: "Alberta@gmail.com", Bio: "Hello I'm Alberta", description: "Alberta: A nurturing force of nature, cultivating community and fostering growth with a heart as vast as the prairies.", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
  { name: "Gator", pic: pic8, reviews: 5, following: 6, email: "Gator@gmail.com", Bio: "Hello I'm Gator", description: "Gator: A dynamic performer, electrifying stages with raw talent and infectious energy, leaving audiences in awe of his magnetic presence.", follow: true, restaurantName1: "Cafe Delight", review1: "An exquisite experience with flavors that dance on the palate.", restaurantName2: "Seaside Eats", review2: "The seafood is fresh, flavorful, and served with a beautiful ocean view."},
];
  ...
  return (
    <div className="profilePageStruct">
      ...
      <div className="entries-section">
        <h1 className="profileName" style={{ "text-align": "left", "margin-left": "200px" }}>
          Entries
        </h1>
        <div>
          <div className="entry">
            <h2>Cafe Delight</h2>
            <p>An exquisite experience with flavors that dance on the palate.</p>
            <button
          ...
          <div className="entry">
            <h2>Seaside Eats</h2>
            <p>The seafood is fresh, flavorful, and served with a beautiful ocean view.</p>
            <button
